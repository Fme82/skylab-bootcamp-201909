...
const { random } = Math
const { errors: { ContentError, CredentialsError } } = require('lambda-util')
const { database, models: { User } } = require('lambda-data')
const bcrypt = require('bcryptjs')

describe('logic - authenticate user', () => {
    beforeAll(() => database.connect(TEST_DB_URL))

    let id, name, surname, email, username, password, type, hash
